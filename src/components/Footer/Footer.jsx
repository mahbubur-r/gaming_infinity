            ...
            <div className='text-white bg-[#000000] md:max-w-[2500px] md:h-[300px] mx-auto'>
                <div className=' flex justify-between md:ml-10 items-center'>
                    <div className='flex justify-between items-center ml-2 md:ml-10'>
                        ...
                        <p className=" ml-3 font-bold text-xl text-white">Gaming Infinity Soluation</p>
                    </div>

                    <div className='footer-card items-center md:w-[170px] mr-2 mt-3 md:mt-10'>
                        <h2 className='font-bold'>Social Links</h2>
                        <div className='flex items-center ml-4 mt-2'>
                            <a href="https://www.linkedin.com/"><i className="mr-2 fa-brands fa-linkedin"></i></a>
                            <a href="https://www.facebook.com/"><i className="mr-2 fa-brands fa-facebook"></i></a>
                            <a href="https://www.x.com/"><i className="mr-2 fa-brands fa-x-twitter"></i></a>
                ...
                <div className='mt-3 md:mt-20 h-[100px]'>
                    ...
                    <p className='text-[#fafafa] font-light text-center mt-2 md:mt-10 py-3'>Copyright © Your Games 2025 - All right reserved</p>
                </div>
            </div>
        </div>
    );
